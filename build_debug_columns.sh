...
echo "🐛 Building DEBUG Two-Column GUI (with visible filenames)..."
echo ""
...
struct ContentView: View {
    ...
    private func preview() {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            ...
            print("👁️ Preview generated: \(operations.count) operations")
...
echo ""
echo "🔍 KEY CHANGES:"
echo "  • Separated FileRowView component"
echo "  • Explicit frame widths"
echo "  • Larger font (12pt)"
echo "  • More spacing"
echo "  • Console logging enabled"
echo ""
echo "📊 Check Console.app for debug output!"
echo ""
